...
download_archives() {
  local RELEASES_JSON_URL="https://api.github.com/repos/btbutts/FlutVierTransmission/contents/releases.json"
...
Documentation=https://github.com/btbutts/FlutVierTransmission
